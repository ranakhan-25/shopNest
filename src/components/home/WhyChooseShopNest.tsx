  ...
  return (
    <section className="relative overflow-hidden bg-white py-20 dark:bg-gray-950 sm:py-24">
      ...
      <motion.div
        ...
        className="absolute -right-32 bottom-10 h-80 w-80 rounded-full bg-purple-500/10 blur-3xl"
      />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-2 text-sm font-medium text-blue-600 dark:border-blue-900 dark:bg-blue-950/40 dark:text-blue-400">
            <Sparkles size={16} />
            Why ShopNest?
          </div>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                {/* Hover Gradient */}
                <div className="absolute inset-0 -z-0 bg-gradient-to-br from-blue-500/[0.04] via-transparent to-purple-500/[0.04] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                ...
                <motion.div
                  ...
                  className="relative z-10 flex h-14 w-14 items-center justify-center rounded bg-blue-50 text-blue-600 transition-colors duration-300 group-hover:bg-blue-600 group-hover:text-white dark:bg-blue-950/50 dark:text-blue-400 dark:group-hover:bg-blue-600 dark:group-hover:text-white"
                >
                  <Icon size={27} />
                </motion.div>
          ...
          {[
            ...
            <div key={label} className="px-4 text-center">
              <motion.p
                ...
                className="text-2xl font-bold text-blue-600 dark:text-blue-400 sm:text-3xl"
              >
                {value}
              </motion.p>
